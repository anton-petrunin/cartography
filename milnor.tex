...
By the area formula, its coastline cannot be degenerate.
...
\parit{Computations.}
Fix $\mu$; regard $s$ and $\nu$ as functions of $a$.
Differentiating the equations, we get $(a+s)'=\tfrac{\sin a}{\sin(a+s)}$.
Since  $0\le a\leq a+s\le \tfrac\pi2$, we have $\sin s\leq s$ and $\mu\cdot\cos (a+s)\geq 0$. Hence
