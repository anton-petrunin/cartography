...
here $|\ -\ |_{\mathbb{S}^2}$ and  $|\ -\ |_{\RR^2}$ stand for the geodesic distance in $\mathbb{S}^2$ and $\RR^2$, respectively.
...
Our solution is inspired by an idea of Gary Lawlor in his proof of the isoperimetric inequality \cite{lawlor}.
In fact, with very minor addition this idea solves a version of Milnor's problem with perimeter instead of area \cite{petrunin2016,petrunin2025}.


\section{Balanced sets}

\begin{wrapfigure}[5]{o}{36mm}
\centering
\vskip-12mm
