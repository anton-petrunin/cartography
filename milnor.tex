...
Indeed, by moving $p$ slightly along the orientation, we increase area and turn of $L_{[p,q]}$;
the latter follows since in a spherical triangle of diameter smaller than $\tfrac\pi2$ exterior angle is greater than an interior angle at another vertex (recall that $\rho\le \tfrac\pi2$).
