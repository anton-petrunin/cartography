...
After rescaling, we may assume that $L_1=1$ (so $f$ is noncontracting) and have to minimize $L_2$.
...
Let $K$ be an admissible set and $S$ be a sector of a disk in the sphere.
...
Following this argument, one can show that if $\Omega$ is not a round disk, then there is a map with distortion ratio strictly less than $\tfrac\rho{\sin \rho}$.
...
The following question addresses a related problem for nonconvex domains; for example, the contiguous territory of your favorite country.
