...
After rescaling, we may assume that $L_1=1$; in other words, $f$ is noncontracting, and we have to minimize $L_2$.
...
In the same paper he formulated the following problem; see also \cite{petrunin2016,petrunin2025}.
...
is increasing in $p$ and decreasing in $q$ with respect to this orientation.
