...
In the same paper, he formulated the following problem; a weaker version this of problem was stated in the expository article by Étienne Ghys \cite{ghys}.
...
the integral of $\sin (a+t)$ plays the role of $\area K$ and $\cos a$ plays the role of $\pi-\turn K$.
Thus, we get
...
Following this argument one can show that if $\Omega$ is not a round disc, then there is a map with distortion ratio strictly less than $\tfrac\rho{\sin \rho}$.
This statement can be taken as an exercise.
